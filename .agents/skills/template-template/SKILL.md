...
uv run python scripts/02_run_analysis.py --project templates/template_template
uv run python scripts/03_render_pdf.py --project templates/template_template
