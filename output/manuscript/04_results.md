...
| `template_prose_project` | 8 | ~35 s | 78/78 | 90%+ |
| `template_autoresearch_project` | 8 | ~30 s | 157/157 | 90%+ |
...
`376+` Markdown shards under `docs/` capture operational knowledge without duplicating auto-generated inventories.
