...
\midrule\noalign{}
\endhead
\texttt{autoresearch} & 8 & ✓ & ✓ & \breaktt{build\_autoresearch\_plan},
...
templates \\
\texttt{core} & 105 & ✓ & ✓ & \texttt{get\_logger},
...
management \\
\texttt{prose} & 8 & ✓ & ✓ & Markdown readability + prose tooling \\
\texttt{publishing} & 44 & ✓ & ✓ & Zenodo, executable bundle, archival
targets \\
\texttt{reference} & 16 & ✓ & ✓ & BibTeX models, parsers, converters \\
\texttt{rendering} & 49 & ✓ & ✓ & PDF/HTML/slide rendering, Pandoc
filters \\
...
clients + cache \\
\texttt{sia} & 9 & ✓ & ✓ & Self-Improving-AI loop: task validation,
harness, metric capture \\
\texttt{skills} & 6 & ✓ & ✓ & \texttt{discover\_skills}, SKILL manifest
regeneration \\
\texttt{steganography} & 11 & ✓ & ✓ & Watermark overlays + hash
manifests \\
\texttt{validation} & 83 & ✓ & ✓ & PDF + Markdown + integrity CLIs \\
\bottomrule\noalign{}
\end{longtable}
}
\end{frame}
...
\begin{block}{\breaktt{infrastructure.autoresearch} (8 files)}
\protect\phantomsection\label{infrastructure.autoresearch-8-files}
...
\begin{block}{\breaktt{infrastructure.core} (105 files)}
\protect\phantomsection\label{infrastructure.core-105-files}
...
\begin{block}{\breaktt{infrastructure.prose} (8 files)}
\protect\phantomsection\label{infrastructure.prose-8-files}
Readability metrics + Markdown tooling for prose-centric manuscripts /
CI gates.
\end{block}

\begin{block}{\breaktt{infrastructure.publishing} (44 files)}
\protect\phantomsection\label{infrastructure.publishing-44-files}
...
\begin{block}{\breaktt{infrastructure.rendering} (49 files)}
\protect\phantomsection\label{infrastructure.rendering-49-files}
...
\begin{block}{\breaktt{infrastructure.sia} (9 files)}
\protect\phantomsection\label{infrastructure.sia-9-files}
...
\begin{block}{\breaktt{infrastructure.skills} (6 files)}
\protect\phantomsection\label{infrastructure.skills-6-files}
...
\begin{block}{\breaktt{infrastructure.validation} (83 files)}
\protect\phantomsection\label{infrastructure.validation-83-files}
