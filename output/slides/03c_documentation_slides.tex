...
architecture provides the tool-use layer aligned with these frameworks,
the 12 declared stages in \texttt{pipeline.yaml}; default full runs use
10 provides the planning scaffold, and the checkpoint system provides
the memory layer.
\end{block}
\end{frame}
