...
packages, about 604 modules, validated by about 7,904
...
\item
  ...
  packages) comprising about 604 Python modules provide
...
\item
  ...
  test doubles. about 7,904 infrastructure tests and 3377+
...
Python packages---comprising about 604 modules and providing
...
layer, the declarative DAG of \texttt{12} \texttt{pipeline.yaml} stages
...
\tightlist
\item
  \textbf{Infrastructure tests} (\texttt{tests/}): about 7,904
...
templates \\
\texttt{core} & 109 & \texorpdfstring{\ensuremath{\checkmark}}{[ok]} & \texorpdfstring{\ensuremath{\checkmark}}{[ok]} & \texttt{get\_logger},
...
\texttt{publishing} & 70 & \texorpdfstring{\ensuremath{\checkmark}}{[ok]} & \texorpdfstring{\ensuremath{\checkmark}}{[ok]} & Zenodo, executable bundle, archival
targets \\
...
\texttt{rendering} & 50 & \texorpdfstring{\ensuremath{\checkmark}}{[ok]} & \texorpdfstring{\ensuremath{\checkmark}}{[ok]} & PDF/HTML/slide rendering, Pandoc
filters \\
...
duration: the full infrastructure test suite (about 7,904
...
We have validated scaling with 15 canonical exemplars under
...
infrastructure subdirectories, about 604 Python
...
substantial: \texttt{378} Markdown files under \texttt{docs/} alone,
...
\subsubsection{\texorpdfstring{\breaktt{infrastructure.core} (109
files)}{infrastructure.core (109 files)}}\label{infrastructure.core-109-files}
...
\subsubsection{\texorpdfstring{\breaktt{infrastructure.publishing} (70
files)}{infrastructure.publishing (70 files)}}\label{infrastructure.publishing-70-files}
...
\subsubsection{\texorpdfstring{\breaktt{infrastructure.rendering} (50
files)}{infrastructure.rendering (50 files)}}\label{infrastructure.rendering-50-files}
...
\NormalTok{├── docs/ (17 top{-}level areas, 378+ markdown files per live counter)}
\NormalTok{├── tests/                       \# Infra suites (467+ files)}
...
agent context \\
\texttt{docs/} directory & 378 files across 17 subdirectories & User
...
introspection rather than hand-maintained: \texttt{378} counts every
