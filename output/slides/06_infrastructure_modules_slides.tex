...
templates \\
\texttt{core} & 110 & ✓ & ✓ & \texttt{get\_logger},
...
\texttt{publishing} & 74 & ✓ & ✓ & Zenodo, executable bundle, archival
targets \\
\texttt{reference} & 16 & ✓ & ✓ & BibTeX models, parsers, converters \\
\texttt{rendering} & 57 & ✓ & ✓ & PDF/HTML/slide rendering, Pandoc
filters \\
...
\begin{block}{\breaktt{infrastructure.core} (110 files)}
\protect\phantomsection\label{infrastructure.core-110-files}
...
\begin{block}{\breaktt{infrastructure.publishing} (74 files)}
\protect\phantomsection\label{infrastructure.publishing-74-files}
...
\begin{block}{\breaktt{infrastructure.rendering} (57 files)}
\protect\phantomsection\label{infrastructure.rendering-57-files}
